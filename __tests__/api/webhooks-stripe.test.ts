...
describe("Stripe webhook", () => {
  ...
  describe("invoice.payment_succeeded", () => {
    ...
    // Track F removed extendSubscriptionToNext5th and every call site, so
    // the €0 "subscription_update" trial-alignment invoice this used to
    // guard against (real production case 2026-09-07:
    // info@amsterdamkids.com and ionescu.adelina1012@gmail.com each
    // produced exactly this pair) can't be produced anymore — there's no
    // billing_reason special-casing left in the handler to test.
