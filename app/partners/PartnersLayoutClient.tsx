 ...
 *
 * Split out of layout.tsx (which stays a server component so it can export
 * metadata — a "use client" file can't) — same split app/(account)/profile
 * etc. use their own layout.tsx for.
 */
...
export default function PartnersLayoutClient({ children }: { children: React.ReactNode }) {
  return (
    <PartnerProvider>
