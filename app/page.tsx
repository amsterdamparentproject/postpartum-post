      ...
      <main className="flex-1 flex flex-col items-center px-6 px-6 md:py-16">
        ...
        <div className="max-w-2xl w-full text-center mb-10">
          ...
          <p className="mt-6 text-base text-dark leading-relaxed max-w-lg mx-auto">
            Instead of searching for community, get it delivered. Every month, we send you a curated friendship starter pack: a match with someone local who's navigating early parenthood like you, plus neighborhood activities handpicked for your families.
          </p>
        </div>
