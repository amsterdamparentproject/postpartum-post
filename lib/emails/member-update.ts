...
function memberUpdateHtml(firstName: string, confirmUrl: string): string {
  const content =
    ...
    bodySection(`
                                    ...
                                    <tr><td dir="ltr" style="font-size:16px;text-align:left;padding:0 0 16px;line-height:1.4;mso-line-height-alt:22.4px">
                                      Alex here, the mom behind Postpartum Post and APP. So excited to have you as one of our Founding Members for the Post — it's almost time for the first round of meetups in July!
                                    </td></tr>
                                    <tr><td dir="ltr" style="font-size:16px;text-align:left;padding:0 0 16px;line-height:1.4;mso-line-height-alt:22.4px">
                                    ...
                                    <tr><td dir="ltr" style="font-size:16px;text-align:left;padding:0 0 16px;line-height:1.4;mso-line-height-alt:22.4px">
                                      <ul style="margin:0;padding:0 0 0 20px;">
                                        ...
                                        <li><span style="font-weight:700">Community Guidelines.</span> We've published our <a href="${SITE_URL}/community-guidelines" style="color:#000000;text-decoration:underline;">Community Guidelines</a> — a guide to how Postpartum Post works and what we expect from members. We'd love for you to take a moment to read them. Safety and community are at the heart of this, and it's important that we are all on the same page. (You're welcome for the pun 😆)</li>
                                      </ul>
                                    </td></tr>
                                    <tr><td dir="ltr" style="font-size:16px;text-align:left;padding:0 0 16px;line-height:1.4;mso-line-height-alt:22.4px">
                                      And finally: please formally confirm your account so that I know you've read the guidelines and are a parent — or expecting — who is 18+. (I added signup confirmation controls for all new members 🙏🏻)
                                    </td></tr>`) +
...
export async function sendMemberUpdateEmail(
  ...
  const { error } = await resend.emails.send({
    from: FROM,
    to: email,
    subject: `${subjectPrefix()}What's new on Postpartum Post 🌱`,
