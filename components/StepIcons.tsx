...
export function SubscribeIcon() {
  return (
    <svg viewBox="0 0 56 44" width="64" height="50" aria-hidden="true" className={styles.subscribeIcon}>
      <rect x="4" y="14" width="48" height="28" rx="2" fill="#D4614A" />
      <polyline points="4,14 28,30 52,14" fill="none" stroke="#B84F3A" strokeWidth="1.5" />
      <line x1="4" y1="42" x2="20" y2="28" stroke="#B84F3A" strokeWidth="1" />
      <line x1="52" y1="42" x2="36" y2="28" stroke="#B84F3A" strokeWidth="1" />
      <path
    ...
    <svg viewBox="0 0 64 66" width="64" height="66" aria-hidden="true" className={styles.chatIcon}>
      ...
      <g className={styles.rightBubble}>
        <path
          ...
          strokeWidth="1"
        />
        <rect x="30" y="42" width="24" height="2.5" rx="1.25" fill="#D4614A" opacity="0.7" />
        <rect x="30" y="48" width="16" height="2.5" rx="1.25" fill="#D4614A" opacity="0.7" />
      </g>
    </svg>
  );
}
...
export function LetterHeartIcon() {
  return (
    <svg viewBox="0 0 56 54" width="64" height="62" aria-hidden="true" className={styles.letterIcon}>
      <rect x="4" y="20" width="48" height="30" rx="2" fill="#D4614A" />
      <line x1="4" y1="50" x2="22" y2="34" stroke="#B84F3A" strokeWidth="1.5" />
      <line x1="52" y1="50" x2="34" y2="34" stroke="#B84F3A" strokeWidth="1.5" />
      <path
